...
class repositoryBranchProtection extends Command {
  ...
  async execute(context, params) {
    ...
    try {
      // Overwrite an existing branch protection
      if (overwrite === true) {
        context.log.debug('Update an existing branch protection')
        // UPDATE a branch protection via GraphQL
        response = await context.octokit.graphql(
        ...
        context.log.debug('Create a new branch protection')
      ...
      context.log.error(' \'repositoryBranchProtection\' failed to create a Branch Protection Rule')
